...
SECRET_KEY = 'n*))jc)1%3r=p5$yr4wk+73l^xs75=vf3p6+=048bphkmmq6xw'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR),'blog_django' ,'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
SASS_PROCESSOR_INCLUDE_DIRS = [
    os.path.join(BASE_DIR, "blog_django/static/sass"),
